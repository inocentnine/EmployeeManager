...
<div class="div_from_aoto" style="width: 500px;">
    ...
    <form action="${pageContext.request.contextPath }/user_updatePassword.action" method="post">
        <div class="control-group">
            <label class="laber_from">ID</label>
            <div  class="controls" ><input class="input_from" type=number name="id" placeholder=" 请输入ID"></input><p class=help-block></p></div>
        </div>
        <div class="control-group">
        ...
        <div class="control-group">
            ...
            <div class="controls" >
                <button class="btn btn-success" style="width:120px;" >修改</button>
            </div>
        </div>
    </form>
</div>
