        ...
        <div class="col-md-12">
            <table class="table table-bordered table-hover">
                <tr>
                 ...
                 <tr>
                     <th>${ServletActionContext.getRequest().getAttribute("employeeEntity").eid }</th>
                     <th>${ServletActionContext.getRequest().getAttribute("employeeEntity").ename }</th>
                     <th>${ServletActionContext.getRequest().getAttribute("employeeEntity").birth }</th>
                     <th>${ServletActionContext.getRequest().getAttribute("employeeEntity").address}</th>
                     <th>${ServletActionContext.getRequest().getAttribute("employeeEntity").participationDate}</th>
                     <th>${ServletActionContext.getRequest().getAttribute("employeeEntity").tele }</th>
                     <th>${ServletActionContext.getRequest().getAttribute("employeeEntity").technicalLevel}</th>
                     <th>${ServletActionContext.getRequest().getAttribute("employeeEntity").monthlySalary }</th>
                     <th>${ServletActionContext.getRequest().getAttribute("employeeEntity").username}</th>
                     <th>
